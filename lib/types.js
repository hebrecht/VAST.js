...
var l_areaPacket = exports.areaPacket = function(type, msg, sender, sourcePos, targetAoI){
    ...
    // list of IDs and positions of nodes that already received the messagepoint
    this.recipients = [];
...
var l_pub = exports.pub = function(matcherID, clientID, aoi, payload, channel){
    ...
    this.parse = function(js_obj) {
      try {
        ...
        //console.log('matcherID: ' + this.matcherID)
        ...
        console.log('pub parse error: ' + e);
      }
    }

      // print out node info
      this.toString = function () {
        return 'matcherID: ' + this.matcherID + 'clientID: ' + this.clientID + ' layer: ' + this.channel + ' AOI: ' + this.aoi.toString()+' payload: '+this.payload;
      }
}
...
var l_sub = exports.sub = function (hostID, hostPos, clientID, subID, channel, aoi) {
    ...
    // print out node info
    this.toString = function () {
        return '[' + this.subID + '] hostID: ' + hostID + ' layer: ' + this.channel + ' AOI: ' + this.aoi.toString();
    }
}
